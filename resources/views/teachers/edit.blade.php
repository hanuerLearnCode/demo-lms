            ...
            <div class="max-w-7xl mx-auto sm:px-8 lg:px-8">
                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    ...
                    <div class="overflow-x-auto px-4 pt-1 pb-4">
                        <form class="form" method="post" action="{{ route('teachers.update', $teacher->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                                <label for="name" class="form-label">Name</label>
                                <input type="text" class="form-control rounded-md" id="name"
                                       name="name" value="{{ $teacher->user->name }}" required>
                                @error('name')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control rounded-md" id="position"
                                       name="position" value="{{ $teacher->position }}" required>
                                @error('position')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control rounded-md" id="email" name="email"
                                       aria-describedby="emailHelp" value="{{ $teacher->user->email }}" required>
                                @error('email')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control rounded-md" id="salary"
                                       name="salary" value="{{ $teacher->salary }}" required>
                                @error('salary')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control rounded-md" id="experience"
                                       name="experience" value="{{ $teacher->experience }}" required>
                                @error('experience')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
