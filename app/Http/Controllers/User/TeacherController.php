...
class TeacherController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if (!$user) {
            return response()->json("Something went wrong! Can not create this user!");
        }
        ...
        $teacher = $this->teacherService->create($teacher_infor);

        if (!$teacher) {
            return response()->json("Something went wrong! Can not create this teacher!");
        }
